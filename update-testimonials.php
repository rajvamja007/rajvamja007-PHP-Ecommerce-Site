...
include_once('includes/config.php');
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "UPDATE testimonial SET name='$t_name',testimonial_data='$t_data' WHERE testimonial_id='$t_id'");
