                            ...
                            <table id="datatablesSimple" class="table table-striped table-bordered" >
                                    ...
                                    ?>  
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><img src="assets/img/banner.jpg" height="90px" width="150px"></img></td> -->
                                            <td><?php echo htmlentities($row['c_name']);?></td>     
                                            <td>
                                            <a href="update-category.php?c_id=<?php echo $row['c_id']?>"><i class="fas fa-edit"></i></a> | 
                                            <a href="manage-categories.php?c_id=<?php echo $row['c_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
